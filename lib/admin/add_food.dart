        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Text("Item Name", style: AppWidget.semibooldTextFieldStyle()),
              ...
              SizedBox(height: 30.0),
              Text("Item Price", style: AppWidget.semibooldTextFieldStyle()),
              SizedBox(height: 10.0),
              Container(
                padding: EdgeInsets.symmetric(horizontal: 20.0),
                width: MediaQuery.of(context).size.width,
              ...
              SizedBox(height: 30.0),
              Text("Item Detail", style: AppWidget.semibooldTextFieldStyle()),
              SizedBox(height: 10.0),
              Container(
                padding: EdgeInsets.symmetric(horizontal: 20.0),
                width: MediaQuery.of(context).size.width,
